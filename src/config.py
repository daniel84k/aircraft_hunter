...
class Settings:
    ...
    watch_min_consecutive_cycles: int
    watch_instant_score: float
    watch_instant_max_offset_body_diameters: float
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        watch_min_score=float(os.getenv("WATCH_MIN_SCORE", "0.80")),
        watch_max_offset_body_diameters=float(os.getenv("WATCH_MAX_OFFSET_BODY_DIAMETERS", "0.05")),
        watch_min_lead_seconds=int(os.getenv("WATCH_MIN_LEAD_SECONDS", "180")),
        watch_min_consecutive_cycles=int(os.getenv("WATCH_MIN_CONSECUTIVE_CYCLES", "2")),
        watch_instant_score=float(os.getenv("WATCH_INSTANT_SCORE", "1.00")),
        watch_instant_max_offset_body_diameters=float(os.getenv("WATCH_INSTANT_MAX_OFFSET_BODY_DIAMETERS", "0.02")),
